...
CONFIGS = [['basic.cfg', 'basic.wad', 3, 5],                                       # 0
           ...
           ['labyrinth_many_6.cfg', 'labyrinth_many_fixed_4.wad', 3, 5],           # 38
           ['labyrinth_many_7.cfg', 'labyrinth_many_fixed_4.wad', 3, 5],           # 39
           ['labyrinth_many_8.cfg', 'labyrinth_many_fixed_4.wad', 3, 5],           # 40
           ['labyrinth_many_9.cfg', 'labyrinth_many_fixed_4.wad', 3, 5],           # 41
           ['labyrinth_many_10.cfg', 'labyrinth_many_fixed_4.wad', 3, 5],          # 42
           ['labyrinth_many_11.cfg', 'labyrinth_many_fixed_4.wad', 3, 5]]          # 43
