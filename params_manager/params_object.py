...
def get_config():
  ...
  opts = {'EXP_PARAMS_MONGO_SERVER': '10.142.0.3', # db if using docker-compose, else specify a host IP (for gcp 10.142.0.3)
  ...
  confDir = os.path.expanduser('~/.params_manager')
...
class ParamsObject(object):
  ...
  def __init__(self, params, usertag=None, userConfirm=True):
    """
    ...
    print('---- Connected to parameter database')
